...
export const SITE_TITLE = 'Calakoche'
export const SITE_TITLE_TAB = 'Calakoche | Tips y más sobre el cuidado infantil.'
export const SITE_DESCRIPTION = 'Mamás, papás, familia y niños felices. Información con el más alto nivel de responsabilidad y compromiso. Todo para ti y tus pequeños.'
export const SITE_APP_NAME = 'Calakoche'
export const SITE_AUTHOR = 'Calakoche'
export const SITE_DOMAIN = 'https://calakoche.com'
export const SITE_LOGO_PUBLISHER = 'https://calakoche.com/assets/img/calakoche_logo_publisher.png'
export const SITE_LOGO_PUBLISHER_WIDTH = 157
export const SITE_LOGO_PUBLISHER_HEIGHT = 60
export const SITE_OG_IMAGE = 'https://calakoche.com/assets/img/social_share.jpg'
export const SITE_TWITTER_OFICIAL = '@calakoche'

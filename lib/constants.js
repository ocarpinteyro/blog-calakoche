...
export const SITE_TITLE_TAB = 'Calakoche | Tu Blog | Sitio Oficial'
export const SITE_DESCRIPTION = 'Calakoche te ayuda a entretener y educar a los niños con el más alto nivel de responsabilidad con el fin de hacer un niño mejor.'
export const SITE_APP_NAME = 'Calakoche'
export const SITE_AUTHOR = 'Calakoche'
export const SITE_DOMAIN = 'https://blog.calakoche.com'

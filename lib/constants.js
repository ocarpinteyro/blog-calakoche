...
export const SITE_TITLE_TAB = 'Calakoche | Para mamás, papás y toda la familia que aman el cuidado de los niños.'
export const SITE_DESCRIPTION = 'Ropa, tips, información y más sobre el cuidado de los niños con el más alto nivel de responsabilidad y compromiso. Todo para hacer un niño mejor.'
export const SITE_APP_NAME = 'Calakoche'
export const SITE_AUTHOR = 'Calakoche'
export const SITE_DOMAIN = 'https://calakoche.com'
export const SITE_LOGO = 'https://calakoche.com/images/social_share.jpg'
